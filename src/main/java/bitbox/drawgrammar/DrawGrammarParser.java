...
public class DrawGrammarParser extends Parser {
        ...
        try {
            ...
            switch (getInterpreter().adaptivePredict(_input, 2, _ctx)) {
                    ...
                    enterOuterAlt(_localctx, 1);
                {
                    ...
                    ((Number_listContext) _localctx).numSet = new HashSet();
                    _localctx.numSet.add(Integer.parseInt((((Number_listContext) _localctx).num != null ? ((Number_listContext) _localctx).num.getText() : null)));
                }
                break;
                case 2:
                    enterOuterAlt(_localctx, 2);
                {
                    ...
                    ((Number_listContext) _localctx).nl.numSet.add(Integer.parseInt((((Number_listContext) _localctx).num != null ? ((Number_listContext) _localctx).num.getText() : null)));
                    ((Number_listContext) _localctx).numSet = ((Number_listContext) _localctx).nl.numSet;
                }
                break;
            }
        } catch (RecognitionException re) {
    ...
    public static class RootContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof DrawGrammarVisitor)
                return ((DrawGrammarVisitor<? extends T>) visitor).visitRoot(this);
    ...
    public static class RangeListContext extends ParserRuleContext {
        ...
        public TerminalNode COMMA_SEP() {
            return getToken(DrawGrammarParser.COMMA_SEP, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof DrawGrammarVisitor)
                return ((DrawGrammarVisitor<? extends T>) visitor).visitRangeList(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RangeElemContext extends ParserRuleContext {
        ...
        public TerminalNode BR_OPEN() {
            return getToken(DrawGrammarParser.BR_OPEN, 0);
        }

        public TerminalNode BR_CLOSE() {
            return getToken(DrawGrammarParser.BR_CLOSE, 0);
        }
        ...
        public TerminalNode STRING() {
            return getToken(DrawGrammarParser.STRING, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_rangeElem;
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof DrawGrammarVisitor)
                return ((DrawGrammarVisitor<? extends T>) visitor).visitRangeElem(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class BitRangeContext extends ParserRuleContext {
        ...
        public TerminalNode RANGE_POINTS() {
            return getToken(DrawGrammarParser.RANGE_POINTS, 0);
        }

        public List<TerminalNode> NUMBER() {
            return getTokens(DrawGrammarParser.NUMBER);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof DrawGrammarVisitor)
                return ((DrawGrammarVisitor<? extends T>) visitor).visitBitRange(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class Number_listContext extends ParserRuleContext {
        ...
        public TerminalNode NUMBER() {
            return getToken(DrawGrammarParser.NUMBER, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof DrawGrammarVisitor)
                return ((DrawGrammarVisitor<? extends T>) visitor).visitNumber_list(this);
            else return visitor.visitChildren(this);
        }
    }
}