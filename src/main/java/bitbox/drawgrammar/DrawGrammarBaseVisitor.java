...
public class DrawGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements DrawGrammarVisitor<T> {
     ...
     */
    @Override
    public T visitRoot(DrawGrammarParser.RootContext ctx) {
     ...
     */
    @Override
    public T visitRangeList(DrawGrammarParser.RangeListContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitRangeElem(DrawGrammarParser.RangeElemContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitBitRange(DrawGrammarParser.BitRangeContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitNumber_list(DrawGrammarParser.Number_listContext ctx) {
        return visitChildren(ctx);
    }
}