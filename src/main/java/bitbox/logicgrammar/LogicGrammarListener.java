...
public interface LogicGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LogicGrammarParser#basednumber}.
	 * @param ctx the parse tree
	 */
	void enterBasednumber(LogicGrammarParser.BasednumberContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogicGrammarParser#basednumber}.
	 * @param ctx the parse tree
	 */
	void exitBasednumber(LogicGrammarParser.BasednumberContext ctx);
}